...
export class CustomerOrderComponent implements OnInit {
  ...
  private getDevice() {
    this.coreService.get(Entity.Device).pipe(untilDestroyed(this)).subscribe();
  }
  ...
  private getUtility() {
    this.coreService.get(Entity.Utility).pipe(untilDestroyed(this)).subscribe();
  }

  private getService() {
    this.coreService.get(Entity.Service).pipe(untilDestroyed(this)).subscribe();
  }
}
